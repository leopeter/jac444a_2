...
private void _setupTask() {
  ...
  TaskExecutorIF<ByteBuffer> functor = new TaskExecutorAdapter<ByteBuffer>() {
                                     ...
                                     SwingUIHookAdapter hook) throws Exception
    {
      ...
      String uri = MapLookup.getMap((ttfLat.getText().toString()),
                                    (ttfLon.getText().toString()),
  	...
  	//======== contentPanel ========
  	{
  		...
  		//======== panel1 ========
  		{
  			...
  			panel1.setLayout(new TableLayout(new double[][] {
  				{0.14, 0.14, 0.14, 0.14, 0.20, 0.05, TableLayout.FILL},// decide the rows
  			...
  			//---- ttfLat ----
  			ttfLat.setText("70 The Pond Road");
  			panel1.add(ttfLat, new TableLayoutConstraints(3, 0, 5, 0, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
			...
			*/
  			panel1.add(jsZoom, new TableLayoutConstraints(3, 2, 5, 2, TableLayoutConstraints.FULL, TableLayoutConstraints.FULL));
